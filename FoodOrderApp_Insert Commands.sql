...
VALUES
  ...
  INSERT INTO `cuisine` (`id`, `name`, `description`, `image_url`, `status`)
VALUES
  ...
  /*Q. 2. Insert following records in restaurant table -  */
   INSERT INTO `restaurant` (`id`, `name`, `address`, `phone_number`, `image_url`, `status`)
VALUES
...
INSERT INTO `fooditem` (`id`, `name`, `description`, `price`, `cuisine`, `cuisine_id`, `restaurant_id`, `status`)
VALUES
...
/*Q. 4. Insert following records in menu table - */
INSERT INTO `menu` (`id`, `restaurant_id`, `status`) VALUES
  (1, 1, 1),
  (2, 2, 1),
  (3, 3, 1),
  (4, 4, 1),
...
INSERT INTO `menu_items` (`id`, `menu_id`, `fooditem_id`, `price`, `status`) VALUES
  (1, 1, 1, 10, 1),
  (2, 1, 4, 15, 1),
  (3, 1, 8, 10, 1),
  (4, 1, 11, 12, 1),
...
INSERT INTO `cart` (`id`, `menu_id`, `fooditem_id`, `price`, `status`) VALUES
  (1, 1, 3, 270, 1),
  (2, 2, 4, 140, 1),
  (3, 3, 7, 100, 1);
...
INSERT INTO `cart_items` (`id`, `cart_id`, `fooditem_id`, `quantity`, `price`) VALUES
  (1, 1, 4, 10, 4),
  (2, 1, 5, 25, 4),
  (3, 1, 13, 14, 5),
  (4, 1, 20, 12, 5),
...
INSERT INTO `shippingDetails` (`id`, `address`, `email`, `phone`) VALUES
...
INSERT INTO `order` (`id`, `cart_id`, `user_id`, `total_price`, `shipping_id`, `status`, `payment_status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `order_items` (`id`, `order_id`, `fooditem_id`, `quantity`, `price`, `status`, `created_at`, `updated_at`) VALUES
